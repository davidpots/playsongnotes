...
var scales = {  'major'             : { 'name'    : 'major',
                ...
                'blues_minor'       : { 'name'    : 'blues (minor)',
                                        'pattern' : 'o--o-ooo--o-' },
                'ionian_mode'       : { 'name'    : 'ionian',
                                        'pattern' : 'o-o-oo-o-o-o' },
                'dorian_mode'       : { 'name'    : 'dorian',
                                        'pattern' : 'o-oo-o-o-oo-' },
                'phrygian_mode'     : { 'name'    : 'phrygian',
                                        'pattern' : 'oo-o-o-oo-o-' },
                'lydian_mode'       : { 'name'    : 'lydian',
                                        'pattern' : 'o-o-o-oo-o-o' },
                'mixolydian_mode'   : { 'name'    : 'mixolydian',
                                        'pattern' : 'o-o-oo-o-oo-' },
